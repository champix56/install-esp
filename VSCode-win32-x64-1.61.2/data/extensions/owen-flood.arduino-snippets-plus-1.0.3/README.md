...
This extension is a fork from [arduino-snippets](https://github.com/ronaldosena/arduino-snippets) and adds configuration options.

-------------------

Supports both `*.ino` and `*.cpp` files.

<img src="https://github.com/OwenFlood/arduino-snippets/raw/HEAD/assets/gif/demo.gif" width="850" height="400"/>
...
| `ifdef`              | [Macro ifdef](https://github.com/OwenFlood/arduino-snippets/blob/HEAD/ )               |
| `ifndef`             | [Macro ifndef](https://github.com/OwenFlood/arduino-snippets/blob/HEAD/ )              |
...
| `elif`               | [Macro elif](https://github.com/OwenFlood/arduino-snippets/blob/HEAD/ )                |
| `sizeof`             | [sizeof()](https://www.arduino.cc/reference/en/language/variables/utilities/sizeof/)                  |
| `undef`              | [Macro undef](https://github.com/OwenFlood/arduino-snippets/blob/HEAD/ )               |
| Digital I/O   |
